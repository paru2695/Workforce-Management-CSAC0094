    ...
    <form id="form1" runat="server">
        <div class="auto-style1">
                ...
                <asp:Label ID="Label5" runat="server" CssClass="newStyle1" Height="72px" Text="Workforce Management" Width="536px"></asp:Label>
                    ...
                    <asp:Button ID="Button5" runat="server" PostBackUrl="~/login.aspx" Text="Logout" Height="22px" Width="128px" />
                <br />
                ...
                <table class="auto-style4">
                    ...
                    <tr>
                        <td class="auto-style5">
                            <asp:Button ID="Button3" runat="server" Text="Users" Width="128px" PostBackUrl="~/adminusers.aspx" OnClick="Button3_Click" Height="22px" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="auto-style5">
                            <asp:Button ID="Button4" runat="server" Text="Access Requests" Width="128px" PostBackUrl="~/AccessRequests.aspx" Height="22px" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
